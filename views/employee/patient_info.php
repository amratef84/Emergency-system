...
use app\models\HospitalScreening;
 ...
 /*employee/view*/
$this->params['breadcrumbs'][] = ['label' => 'View Patient', 'url' => ['view']];
            ...
            <div class="col-sm-4">
             ...
             <div class="col-sm-4">
              ...
              <div  class="wrap-input100 validate-input" >
                    ...
                    /*if($model3!=null)
                      { model2
                        $form->field($model3, 'Session_ID')->textInput(['class' => 'form-control','readonly'=>'true'])->label(false) 
                  }*/
                  ?>           
          </div>
                </div>
              ...
              <div  class="wrap-input100 validate-input" >
                    ...
                    /*if($model3==null)
                      {
                        $form->field($model3, 'Session_status')->textInput(['class' => 'form-control','readonly'=>'true'])->label(false)
                      }*/
                       ?>           
          </div>
                </div>
          ...
          <div class="row no-gutters">
            <?php
              ...
              <div class="dash-content">
                <label class="tx-primary"><?= $sensor_name ?></label>
                <h2><?= $m->Value?></h2>
              </div><!-- dash-content -->
            </div><!-- col-3 -->
              <?php
        ...
        <div class="col-lg-4">
           ...
           <div class="section-wrapper">
              <div class="form-layout form-layout-4">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <?php
                      if($model4!=null)
                     {
                      echo $form->field($model4, 'Ticket_ID')->textInput(['class' => 'form-control','readonly'=>'true','value'=>$category])->label(false);
                     }
               ...
               <?=Html::activeDropDownList($model4,'Unit_id',
                ArrayHelper::map(Unit::find()->all(), 'Unit_id','Unit_name'),['class' =>'form-control','id'=>"select_unit",'disabled'=>'true'])?>
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <?php 
                     if($model4!=null)
                     {
                     echo $form->field($model4, 'Session_status')->textInput(['class' => 'form-control','readonly'=>'true'])->label(false);
                     }
                     ?>  
                  </div>
                </div><!-- row -->
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <?php 
                     if($model4!=null)
                     {
                     echo $form->field($model4, 'reason')->textInput(['class' => 'form-control','value'=>''])->label(false);
                     }
                   ?>  
                  </div>
                </div><!-- row -->
                              ...
                              if($model4!=null)
                                {
                                    ...
                                    {
                                    echo $form->field($model4, 'advices')->textArea(['rows' => '9'])->label(false);
                                    }
                                    else
                                    {
                                    echo $form->field($model4, 'advices')->textArea(['rows' => '9','value'=>$category->Advice1()])->label(false);
                                    }                            
                            }
                             ?>
                        </div>
              ...
              <div class="form-layout form-layout-4">
                     <div class="form-layout-footer mg-t-30">
                        <button name="submit" value="save" type="submit" class="btn btn-primary bd-0"><?= Yii::t('app', 'Save'); ?></button>
                         &nbsp;&nbsp; &nbsp;
                     <button style=" background-color:green;"  name="submit" value="check" type="submit"  class="btn btn-primary bd-0"><?= Yii::t('app', 'Checkout'); ?></button>
